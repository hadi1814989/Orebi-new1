  ...
  return (
    <section>
      ...
      <div className=" max-w-container mx-auto">
        <h3 className="font-sans text-[49px] pt-[124px] font-bold text-[#262626] ">
          Contacts
        </h3>
      ...
      <form>
          <div className="flex flex-col">
            ...
            <input
              ...
              className=" border-b-[#f0f0f0] pl-0  focus:border-b focus:border-b-[#f0f0f0] focus:outline-none
         ...
         <button type="submit" className="px-10 py-4  border-black border-2 bg-white text-black hover:bg-black hover:text-white duration-300">
         Contact
          </button>
         </div>
        </form>
      </div>
      <div className="pt-[120px] max-w-container max-auto ps-10">
        <iframe
